...
DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://bmrs41378_db_user:VnIUMf1Z7s7JfIdG@bhardwaj143.i0lvyet.mongodb.net/?retryWrites=true&w=majority&appName=Bhardwaj143")  # Add your own atlas db
